...
\Keywords{SUBROUTINE PACKAGE ROUTINE IOSPACK IOSPUT IOSSIZ IOSCLR OUTPUT-ONLY OUTPUT IBM FULLSCREEN FULL-SCREEN SCREEN IO 7171 3270 X3270 VT100 COMPATIBLE SERIES GENERAL IBM INTERFACE PACK VM CMS}
\Author{E. Perotto}                    \Library{KERNLIB, IBM VM/CMS only}
\Submitter{}                                \Submitted{03.07.1985}
\Language{IBM Assembler}                 %   %\Revised{}
\Cernhead{General Purpose IBM VM/CMS Non-Graphics Full Screen Interface Package}
