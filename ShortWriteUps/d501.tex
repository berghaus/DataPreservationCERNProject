...
\Keywords{CONSTRAIN, NON, LINEAR, LEAST, SQUARES, MAXIMUM, LIKELIHOOD, DATA, FIT, FITTING, ESTIMATION}
\Author{W. M\"onch, B. Schorr}                   \Library{MATHLIB}
\Submitter{W. M\"onch}                           \Submitted{15.03.1993}
\Language{Fortran}                              %\Revised{}
\Cernhead{Constrained Non-Linear Least Squares and Maximum Likelihood Estimation}
