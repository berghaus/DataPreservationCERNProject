...
\Keywords{SUBROUTINE PACKAGE CKRACK CCOPYL CCOPYR CFILL CLEFT CRIGHT CSQMBL CSQMCH CLTOU CUTOL CSETDI CSETHI CSETOI CTRANS CCOPIV CSETVI CSETVM CCOSUB CENVIR ICDECI ICHEXI ICOCTI NCDECI NCHEXI NCOCTI ICFIND ICFILA ICEQU ICINQ ICINQL ICINCU ICNUMU ICFMUL ICFNBL ICLOC ICLOCL ICLOCU ICLUNS ICNEXT ICNTH ICNTHL ICNTHU ICNUM ICNUMA ICTYPE LNBLNK SLATE CHARACTER MANIPULATION STRING-PARSING HANDLING PARSE}
\Author{J. Zoll}                        \Library{KERNLIB}
\Submitter{}                            \Submitted{02.06.1989}
\Language{Fortran}                \Revised{01.04.1994}
\Cernhead{Utility Routines for Character String Parsing and Construction}
